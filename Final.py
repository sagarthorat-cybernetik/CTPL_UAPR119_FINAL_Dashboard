...
class GradeSuggestionEngine:
    ...
    def suggest_ranges_equal_width(self, rejected_cells: List[Dict]) -> Dict:
        ...
        total = len(volts)
        if total == 0:
            return {"grades":[], "total_cells":0, "accepted_count":0, "accepted_pct":0.0, "ignored_outliers_count":0}
        ...
        if not filtered_volts:
            return {"grades":[], "total_cells":total, "accepted_count":0, "accepted_pct":0.0, "ignored_outliers_count":ignored}
